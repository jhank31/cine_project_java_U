...
public class ViewConfiteria extends JFrame implements ActionListener {
	...
	public void getConfiteria() {
		...
		spinner_combo2 = new JSpinner(new SpinnerNumberModel(0, 0, 10, 1));
		...
		spinner_combo3 = new JSpinner(new SpinnerNumberModel(0, 0, 10, 1));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cantidadCombo1 > 0) {
			...
			datosDeCompra += "Combo Perro Gaseosa x" + cantidadCombo1 + ", ";

		}

		if (cantidadCombo2 > 0) {

			datosDeCompra += "Combo Hamburguesa Gaseosa x" + cantidadCombo2 + ", ";

		}

		if (cantidadCombo3 > 0) {

			datosDeCompra += "Combo Amigos x" + cantidadCombo3 + " ";
		}
		...
		if (e.getSource() == ButtomSiguiente) {
			ModelUser.descuentos(totalAPagar);
